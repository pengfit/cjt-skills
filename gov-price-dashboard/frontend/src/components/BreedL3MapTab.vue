...
/* 2026-07-29 彻底统一(与 /taxonomy 一致):
   ...
   保留: .canon-table-wrap / .canon-cell-strong / .canon-l3-pill* / .canon-conf* / .canon-source-tag /
         .ctx-input / .ctx-search-wrap / .ctx-search-icon / .ctx-drawer* / .canon-time / @keyframes 等。*/
