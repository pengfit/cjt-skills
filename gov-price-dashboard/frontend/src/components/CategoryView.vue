...
const CATEGORY_EMOJI = {
  '管材管件':'⚙️','电气材料':'⚡','钢材':'🔩','建筑材料':'🏗️','绿化苗木':'🌿',
  '商品混凝土':'🧱','石材/砂石':'🪨','市政构件':'🔳','防水材料':'☂️','砖/地砖':'🟫',
  '门窗型材':'🚪','塑料/化工材料':'🧪','玻璃':'🔮','涂料/油漆':'🎨','保温材料':'❄️',
  '水泥':'🏭','砂石骨料':'⛰️','铜材':'🟡','消防器材':'🔥','混凝土外加剂/砂浆':'🔨',
  '公用事业费':'💡','阀门/仪表':'⚖️','化工燃料':'⛽','五金配件':'🔧','铝材/铝合金':'🔷',
  '散热器/采暖':'🌡️','机械设备':'🛠️','沥青类':'🛢️','瓦':'🏠','劳务/工种':'👷',
  '陶瓷/卫生洁具':'🚿','铁艺/铸铁件':'⚫','网格布/土工材料':'🕸️','龙骨/吊顶':'🪚',
  '砌块/砖':'⬛','金属围护材料':'🛡️','密封材料':'🔒','焊接材料':'⚔️','其他':'📦',
}
