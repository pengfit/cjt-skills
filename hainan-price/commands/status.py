...
def main():
        ...
        if cnt:
            r = es.search(
                ...
                aggs={
                    ...
                    'by_region':  {'terms': {'field': 'region.keyword', 'size': 20}},
            ...
            print('  各区域:')
            for b in r['aggregations']['by_region']['buckets']:
                print(f'    {b["key"]:15s} {b["doc_count"]:,}')
            print('  章节(TOP 30):')
    ...
    print('\n=== MinIO ===')
    try:
        from utils import get_s3_client, ensure_bucket
